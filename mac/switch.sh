...
# Switch K375s to other device
#                                                                                                                 A        B    C    D       E       F    G
hidapitester --vidpid ${RCVR_VID}:${RCVR_PID} --usage 0x0001 --usagePage 0xFF00 --open --length 7 --send-output 0x10,${KYB_ID},0x08,0x1d,${KYB_CH},0x00,0x00
# Switch MX Master 2S to other device
#                                                                                                                 A       B       C   D       E      F    G
hidapitester --vidpid ${RCVR_VID}:${RCVR_PID} --usage 0x0001 --usagePage 0xFF00 --open --length 7 --send-output 0x10,${MSE_ID},0x09,0x1a,${MSE_CH},0x00,0x00
